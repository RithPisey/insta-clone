		...
		<div>
			...
			>
				...
				>
                    ...
                    min-h-[800px]  pt-4 px-4 
                    pb-20 text-center sm:block sm:min-h-screen sm:p-0'
					>
						<Transition.Child
							...
							<div>
								...
								<div className='mt-2'>
									<input
										...
										className='border-none focus:ring-0 outline-none w-full text-center'
									/>
								</div>
							</div>
							<div className='mt-5 sm:mt-6'>
								<button
                                 ...
                                 border border-transparent shadow-sm px-4 py-2 bg-red-600 text-base font-medium
                                  text-white hover:bg-red-700 focus:outline-none focus:ring-inset-0
                                   focus:ring-offec-2 focus:ring-red-500 sm:text-sm disabled:bg-gray-300
